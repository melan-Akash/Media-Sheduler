...
export const sendPostScheduledEmail = async (to, userName, postDetails) => {
...
export const sendAccountConnectedEmail = async (to, userName, accountDetails) => {
...
export const sendPostPublishedEmail = async (to, userName, postDetails) => {
